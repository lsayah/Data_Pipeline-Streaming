...
with DAG(
    ...
    @task(task_id="compute_top_tracks", trigger_rule="all_done")
    ...
    @task(task_id="compute_artist_stats", trigger_rule="all_done")
    ...
    @task(task_id="compute_p2p_metrics", trigger_rule="all_done")
